        ...
        <form class="contact-form row">
           <div class="form-field col-lg-6">
              <div class="row ">
                  ...
                  <div class="col-md-7"> --}}
                      <select class="input-text js-input form-select form-select-sm" aria-label=".form-select-sm example"required>
           ...
           <div class="form-field col-lg-12">
              <input class="btn btn-cta" type="submit" value="Submit">
           </div>
        </form>
     </section>
